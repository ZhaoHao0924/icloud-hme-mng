...
| Phase 8 操作审计、移动端适配与错误体验 | 进行中 | 2026-08-14 | - | `AUD-001` 与 `QA-009` 已完成隐私安全审计 schema、查询与安全回归；`QA-010` 已完成账户、凭据、别名、收件箱和设置页面及关键对话框的四视口 Playwright 验收基线；iOS Safari 与 Android Chrome 真机或云设备冒烟仍待完成。FE-601、ERR-001 与 QA-011 仍待开发 |
